...
# Last Change       - Tue  7 Dec 02:47:45 GMT 2021
...
printf '\e[92m:)\e[0m Approach 1, using C-style `for` loop:\n'
...
printf '\e[93m:|\e[0m Approach 2, using `while` loop:\n'
Array=(100 90 80 70 60 50 40 30 20 10)
...
printf '\e[91m:(\e[0m Approach 3, using `extdebug` & `$BASH_ARGV`:\n'
Array=(100 90 80 70 60 50 40 30 20 10)
